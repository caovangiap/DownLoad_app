package caogiap.lib.downloader.core

import caogiap.lib.downloader.core.database.DownloaderDao
import caogiap.lib.downloader.core.model.DownloaderData
import caogiap.lib.downloader.core.model.StatusModel
import caogiap.lib.downloader.helper.ConnectCheckerHelper
import caogiap.lib.downloader.helper.ConnectionHelper
import caogiap.lib.downloader.helper.MimeHelper
...
internal data class DownloadTask(
    ...
    private fun detectFileName() {
        ...
        if (fileName == null) {
            ...
            fileName =
                if (fileName == "") System.currentTimeMillis().toString()
                else fileName
