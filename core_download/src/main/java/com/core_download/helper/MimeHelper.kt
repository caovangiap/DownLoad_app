...
internal object MimeHelper {
     ...
     * @param extension
     */
    private fun add(@Size(min = 1) mimeType: String, @Size(min = 1) extension: String) {
     ...
     * @return
     */
    fun hasMimeType(@Size(min = 1) mimeType: String): Boolean {
     ...
     * @return
     */
    fun guessMimeTypeFromExtension(@Size(min = 1) extension: String): String? {
     ...
     * @return
     */
    fun hasExtension(@Size(min = 1) extension: String): Boolean {
     ...
     * @return
     */
    fun guessExtensionFromMimeType(@Size(min = 1) mimeType: String): String? {
