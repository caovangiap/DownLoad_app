...
public class DownloadManagerService extends Service {
    ...
    private static final String ACTION_RESET_DOWNLOAD_FINISHED = AdsManager.APPLICATION_ID + ".reset_download_finished";
    private static final String ACTION_OPEN_DOWNLOADS_FINISHED = AdsManager.APPLICATION_ID + ".open_downloads_finished";
