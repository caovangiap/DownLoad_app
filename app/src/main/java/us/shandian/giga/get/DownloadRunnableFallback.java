...
import us.shandian.giga.postprocessing.SharpStream;
...
public class DownloadRunnableFallback extends Thread {
    private static final String TAG = "DownldRunnableFallback";
...
//        if (AdsManager.DEBUG && !mMission.unknownLength && start > 0) {
