...
import com.example.download_app.BuildConfig;
...
public class DownloadManagerService extends Service {
    ...
    private static final String ACTION_RESET_DOWNLOAD_FINISHED = BuildConfig.APPLICATION_ID + ".reset_download_finished";
    private static final String ACTION_OPEN_DOWNLOADS_FINISHED = BuildConfig.APPLICATION_ID + ".open_downloads_finished";
...
//        if (icLauncher != null) icLauncher.recycle();
    ...
    private PendingIntent makePendingIntent(String action) {
        ...
        return PendingIntent.getService(this, intent.hashCode(), intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    }
